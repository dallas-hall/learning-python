...
user_profiles.append(
	build_profile("john", "abc123", email="john79@gmail.com", subscribe=True, interests=["sport", "health"]))
user_profiles.append(
	build_profile("jane", "qwerty", email="jane88@gmail.com", subscribe=False, interests=["shopping", "travel"]))
