...
# In the last challenge, you saw how XOR worked at the level of bits. In this one, we're going to cover the properties
# of the XOR operation and then use them to undo a chain of operations that have encrypted a flag. Gaining an intuition
# for how this works will help greatly when you come to attacking real cryptosystems later, especially in the block ciphers category.
#
...
#
# Let's try this out in action! Below is a series of outputs where three random keys have been XOR'd together and with
# the flag. Use the above properties to undo the encryption in the final line to obtain the flag.
#
...
flag_xor_key1_xor_key2_xor_key3_binary = binascii.unhexlify(flag_xor_key1_xor_key2_xor_key3_hex)
print("flag_xor_key1_xor_key2_xor_key3_binary: ")
print(flag_xor_key1_xor_key2_xor_key3_binary)

flag_binary = xor(xor(xor(key1_binary, key2_binary), key3_binary), flag_xor_key1_xor_key2_xor_key3_binary)
print('flag_binary :')
print(flag_binary)
print(flag_binary.decode())
