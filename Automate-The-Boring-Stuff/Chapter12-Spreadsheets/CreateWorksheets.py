...
logging.info('Starting CreateWorksheets.py')
...
logging.info('Create a new worksheet.')
time.sleep(0.005)
workbook.create_sheet('Sheet-Two')
worksheet2 = workbook['Sheet-Two']
print(workbook.sheetnames)
print(worksheet2.title)

logging.info('Copying an existing worksheet to a new worksheet.')
time.sleep(0.005)
worksheet3 = workbook.copy_worksheet(worksheet)
print(workbook.sheetnames)

logging.info('Saving the spreadsheet. Will overwrite without warning')
time.sleep(0.005)
workbook.save(Path.cwd() / 'output' / 'new-spreadsheet-with-new-worksheets.xlsx')
